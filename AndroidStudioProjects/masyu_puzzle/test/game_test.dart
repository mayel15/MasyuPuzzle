  ...
  group('Game tests', () {
    ...
    test('checkNbvoisins should return the correct number of neighbors for each cell', () {
      ...
      game.grid.listCells = [
        ...
        [Cell(2, 0, CellType.none), Cell(2, 1, CellType.black), Cell(2, 2, CellType.none)]
      ];
      game.linkedCells();
      Cell c1 = game.grid.listCells.elementAt(0).elementAt(0);
      Cell c2 = game.grid.listCells.elementAt(0).elementAt(1);
      game.play(c1, c2);
      //final expectedNbVoisins = [1, 2, 2, 2, 2, 2, 2, 1, 1];
      expect(c1.getNbVoisins()/2, equals(1));
