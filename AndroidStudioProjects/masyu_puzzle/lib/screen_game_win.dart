...
class MyScreenGameBlur extends StatefulWidget {
  const MyScreenGameBlur({super.key});

  @override
  State<StatefulWidget> createState() => _MyScreenGameBlur();
}

class _MyScreenGameBlur extends State<MyScreenGameBlur> {
  @override
